...
def _private_rag_scenario() -> ScenarioCreate:
    return ScenarioCreate(
        name="Fictional Northstar Private RAG",
        description=(
            "A fictional regulated knowledge assistant spanning controlled cloud and private data."
        ),
...
def _real_time_scenario() -> ScenarioCreate:
    return ScenarioCreate(
        name="Fictional Meridian Real-Time Inference",
        description=(
            "A fictional digital service requiring low-latency, high-availability model inference."
        ),
...
def _hybrid_platform_scenario() -> ScenarioCreate:
    return ScenarioCreate(
...
def demo_scenarios() -> tuple[ScenarioCreate, ...]:
    return (
        _private_rag_scenario(),
        _real_time_scenario(),
        _hybrid_platform_scenario(),
    )
